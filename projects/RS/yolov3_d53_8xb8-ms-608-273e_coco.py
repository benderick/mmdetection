_base_ = ['/icislab/volume3/benderick/futurama/openmmlab/mmdetection/configs/_base_/schedules/schedule_1x.py', '/icislab/volume3/benderick/futurama/openmmlab/mmdetection/configs/_base_/default_runtime.py']
# model settings
...
train_cfg = dict(max_epochs=273, val_interval=1)
